...
INSERT INTO mecanico_ot (orden_id, mecanico_id, horas_trabajadas) VALUES (2, 2, 3.5);
INSERT INTO mecanico_ot (orden_id, mecanico_id, horas_trabajadas) VALUES (3, 3, 1.5);

-- Insertar diagnósticos de ejemplo
INSERT INTO diagnosticos (orden_id, vehiculo_id, mecanico_id, tramas_hex, codigos_falla, observaciones) VALUES
(1, 1, 2, '43 01 03 00 41 01 0C 00', '{"P0103": "Voltaje alto en circuito del sensor MAP"}', 'Sensor MAP con señal intermitente'),
(2, 2, 2, '43 01 0A 00', '{"P010A": "Circuito del sensor de temperatura del aire de admisión"}', 'Sensor de temperatura defectuoso');

-- Insertar asignación de repuestos a órdenes
INSERT INTO asignacion_repuesto (orden_id, repuesto_id, cantidad) VALUES (2, 1, 1);
INSERT INTO asignacion_repuesto (orden_id, repuesto_id, cantidad) VALUES (2, 2, 1);
INSERT INTO asignacion_repuesto (orden_id, repuesto_id, cantidad) VALUES (2, 3, 1);
INSERT INTO asignacion_repuesto (orden_id, repuesto_id, cantidad) VALUES (3, 4, 2);

-- Insertar evidencias de ejemplo
INSERT INTO evidencias (orden_id, tipo, url_cloudinary, etiqueta, descripcion) VALUES
(2, 'foto', 'https://res.cloudinary.com/demo/image/upload/v1234567890/antes_freno.jpg', 'antes', 'Estado inicial de las pastillas de freno'),
(2, 'foto', 'https://res.cloudinary.com/demo/image/upload/v1234567891/durante_freno.jpg', 'durante', 'Proceso de reemplazo de pastillas'),
(2, 'foto', 'https://res.cloudinary.com/demo/image/upload/v1234567892/despues_freno.jpg', 'despues', 'Estado final tras reemplazo');

-- Insertar presupuestos
INSERT INTO presupuestos (orden_id, total, estado, motivo_rechazo) VALUES (2, 185.50, 'aprobado', NULL);
INSERT INTO presupuestos (orden_id, total, estado, motivo_rechazo) VALUES (3, 45.00, 'aprobado', NULL);